  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-14 bg-[#0d0d0d] border-b border-[#1e1e1e] flex items-center justify-between px-6">
      <Link to="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
        <Logo />
        <span className="text-white font-bold text-base tracking-tight">Worldwide</span>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="px-4 py-1.5 text-sm rounded-lg font-medium border border-[#20F3C7]/30 text-[#20F3C7] hover:bg-[#20F3C7]/10 transition-colors"
        >
          Register
        </button>
      </div>
