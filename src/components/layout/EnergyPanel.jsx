  ...
  return (
    <div className="flex flex-col h-full overflow-hidden fade-in">
      ...
      <div className="hidden md:flex flex-1 overflow-hidden">
        ...
        <div className="w-96 border-l border-[#222] flex flex-col p-5 overflow-hidden flex-shrink-0">
      ...
      <div className="flex md:hidden flex-col flex-1 overflow-hidden">
        ...
        {/* World map */}
        <div className="flex-1 min-h-0 overflow-hidden border-b border-[#222] p-2">
          <WorldMapVectorMap
            data={activeCountryData}
            color={config.color}
            unit={config.unit}
        ...
        {/* Bottom trend chart */}
        <div className="overflow-hidden p-2" style={{ flex: "0 0 28%" }}>
          <EnergyLineChart
            productionData={worldProd}
            consumptionData={worldCons}
            productionLoading={worldLoading.production}
